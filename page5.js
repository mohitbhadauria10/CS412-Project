...
function update(stateVar) {
 ...
 // Read data from file - State_Confirmed-1.csv to display Death Cases
...
// Define tooltip to show Death cases
...
var mouseover = function(d) {
  tooltip
      ...
      .style("opacity", 1)
  tooltip
    .html(d.Code +"-Death Cases: " + d[stateVar])
  }
...
var updateVar = svg.selectAll("rect").data(data)
updateVar.enter()
  .append("rect")
  .merge(updateVar)
